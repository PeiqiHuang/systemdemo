...
<form action="${base}/admin/sys/user/userList.do" method="post" id="sf">
	<table class="SearchTable" cellspacing="1" cellpadding="4">
		<tr>
			 <td class="Search_Label">登录名:</td>
			 <td class="Search_Field"><input type="text" name="loginName" value="${user.loginName}" class="NoneBorderTextBox" /></td>
			 <td class="Search_Label">真实姓名:</td>
			 <td class="Search_Field"><input type="text" name="realName" value="${user.realName}" class="NoneBorderTextBox" /></td>
		</tr>
		<tr>
